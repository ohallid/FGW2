function [mm] = M3_1(bm, HL_bar, c, A, m, s, x, x_0, z, t, T, Ht_bar, sigma )
...
x2      = sqrt(pi) / 2 / root2 / ( c * HL_bar ) * F3_1(x, x_0,  c*HL_bar, t, T, sigma);
x3      = sqrt(pi) / 2 / root2 / ( c * HL_bar ) * F3_1(x, x_0,- c*HL_bar, t, T, sigma);
x_var   = x2 - x3 ;
