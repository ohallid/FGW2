function [ xx, zz, ww, bb, dpt ] = series_half_sinusoid_plots_3_copy_no_checks_p(HL_bar , HV_bar, Ht_bar, t, T, mmax, sigma )
...
dx      = 0.1;            % x-step
dz      = 0.1;            % z-step
x       = [-5:dx:5 ];       % x = 10 equivalent to 10 * \sigma (FWHM, PB F(x) )
z       = [0:dz:HV_bar ];
