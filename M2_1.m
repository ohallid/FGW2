function [mm] = M2_1(bm, HL_bar, c, A, m, s, x, x_0, z, t, T, Ht_bar, sigma )
...
x1           = 1 / N1 / N1 * c * c * F2_1(x, x_0, s * HL_bar, t, sigma   ) / ( c*c - s * s / HL_bar / HL_bar) ;  
x2           = 1 / N1 / N1 * c * c * F2_1(x, x_0, c * HL_bar, t, sigma   ) /  c / ( c - s / HL_bar );
x3           = 1 / N1 / N1 * c * c * F2_1(x, x_0,-c * HL_bar, t, sigma   ) /  c / ( c + s / HL_bar );
x2p          = 1 / N1 / N1 * c * c * F2_1(x, x_0, c * HL_bar, t-T, sigma ) /  c / ( c - s / HL_bar );
x3p          = 1 / N1 / N1 * c * c * F2_1(x, x_0,-c * HL_bar, t-T, sigma ) /  c / ( c + s / HL_bar );
